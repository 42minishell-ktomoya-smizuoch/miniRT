...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/06/16 21:05:35 by smizuoch          #+#    #+#             */
/*   Updated: 2024/06/16 21:06:48 by smizuoch         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//     return vec_add(sphere->center0, vec_scalar(vec_sub(sphere->center1,
// sphere->center0), (time - sphere->time0) / (sphere->time1 - sphere->time0)));
// }

// int hit_moving_sphere(t_hittable *self,
// t_ray *ray, t_limits l, t_hit_record *rec) {
//     t_moving_sphere *sphere = (t_moving_sphere *)self->data;
//     t_vec3 oc = vec_sub(ray->origin,
		// moving_sphere_center(sphere, ray->time));
...
//     t_vec3 outward_normal = vec_normalize(vec_sub(rec->point,
// moving_sphere_center(sphere, ray->time)));
...
// t_hittable new_moving_sphere(t_vec3 center0, t_vec3 center1, double time0,
// double time1, double radius, t_color color,
// t_material_type material, double fuzz, double ref_idx) {
